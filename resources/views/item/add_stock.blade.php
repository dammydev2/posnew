    ...
    <div class="row">
        ...
        <div class="panel panel-primary col-lg-6">
          ...
          <div class="panel-body">
            ...
            <input type="hidden" value="{{ $row->quantity }}" name="quantity" class="form-control" placeholder="e.g. 10, 20">

            <div class="form-group">
                <label>Quantity</label>
                <input type="text" name="quantity2" class="form-control" placeholder="e.g. 10, 20">
            </div>
